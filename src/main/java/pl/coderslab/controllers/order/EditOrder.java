...
public class EditOrder extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!exit) {
            ...
            request.getServletContext().getRequestDispatcher("/jsp/order/edit_order.jsp").forward(request, response);
        } else {
            response.sendRedirect(getServletContext().getContextPath() + "/order/listOfOrders?msg=Zaktulizowano%20zlecenie");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (orderId != null) {
            ...
            response.sendRedirect(getServletContext().getContextPath() + "/order/listOfOrders");
        }
    }
