...
<main role="main" class="flex-shrink-0">
    <div class="container">
        ...
        <div class="rounded border p-5">
            ...
            <form style="text-align: left" method="post" action="${pageContext.request.contextPath}/order/editOrder">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary" type="button"
                                        onclick="window.location.href='${pageContext.request.contextPath}/order/addCustomer?orderId=${order.id}'">
                                    Nowy klient
                                </button>
                            </div>
                        </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary" type="button"
                                        onclick="window.location.href='${pageContext.request.contextPath}/order/addVehicle?orderId=${order.id}&customerId=${order.customerId}'">
                                    Nowy pojazd
                                </button>
                            </div>
                        </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <textarea name="repairDescription" class="form-control"
                                  placeholder="Opis naprawy problemu / awarii"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <div class="input-group">
                            ...
                            <input name="manhourCost" id="costOfmanHour" type="text" class="form-control"
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <button type="submit" class="btn btn-primary" name="action" value="update">Zapisz zmiany
                        </button>
                    </div>
                </div>
